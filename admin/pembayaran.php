	...
	<div class="container-fluid" style="color: black;font-family: Myriad Pro Light">
		<div class="row">
									...
									<div class="col-md-3">
										...
										<table class="table table-striped table-hover" align="center">
											...
											<tr>
												...
												<td width="5%">:</td>
												<td align="left"><?php echo $tarif['kode_tarif']."<br>"; $aksi->rupiah($tarif['tarif_permtr']); ?></td>
											</tr>
										</table>
									</div>
									<div class="col-md-9">
										...
										<div class="table-responsive">
											<table class="table table-bordered table-striped table-hover">
												<thead>
													...
													<th><center>Tarif/<br>Mtr</center></th>
													...
													<?php  
														...
														if ($data=="") {
															...
															<tr>
																...
																<td align="center"><?php $aksi->rupiah($r['tarif_permtr']) ?></td>
			...
			<?php }}elseif(isset($_GET['id_pelanggan'])){ 
				...
				$sum_akhir = ($tagihan['jumlah_bayar']+5000);
										...
										<div class="col-md-12">
											<form method="post">
											 		<tfoot>
												 		...
												 		<tr>
												 			<td colspan="7" align="right" valign="center">TARIF/Mtr</td>
												 			<td colspan="2" align="center" valign="center">
												 				<input type="text" name="tarif_permtr" value="<?php echo @$tagihan['tarif_permtr']; ?>" readonly class="form-control">
												 			</td>
												 		</tr>
												 		<tr>
