<?php  
	...
	$kode = isset($petugas['id_petugas']) ? $petugas['id_petugas'] : '';
							...
							<div class="col-md-12">
								<form method="post">
									...
									<div class="form-group">
										<?php 
										if (@$_GET['id']=="") {?>
											<input type="submit" name="simpan" class="btn btn-primary btn-block btn-lg" value="SIMPAN" style="background: #7990ff;">
										 <?php }else{?>
											<input type="submit" name="ubah" class="btn btn-success btn-block btn-lg" value="UBAH" style="background: #7990ff;">
										 <?php } ?>
										<a href="?menu=petugas" class="btn btn-danger btn-lg btn-block" style="background: #f08080;">RESET</a>
									</div>
								</form>
							</div>
						</div>
