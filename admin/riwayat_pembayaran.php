<?php  
	if (!isset($_GET['menu'])) {
	 	header('location:hal_utama.php?menu=riwayat_pembayaran');
	}
	...
	if (isset($_POST['bcari'])) {
		...
		$link_print = "printt.php?bulan=$bulanini&tahun=$tahunini";
        $link_excel = "printt.php?excel&bulan=$bulanini&tahun=$tahunini";
	}
?>
<!DOCTYPE html>
<html>
