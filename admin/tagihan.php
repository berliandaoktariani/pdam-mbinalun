<?php  
	...
	if (isset($_POST['bcari_text'])) {
		$text = $_POST['tcari'];
		$cari = "WHERE id_pelanggan LIKE '%$text%' OR bulan LIKE '%$text%' OR tahun LIKE '%$text%' OR jumlah_meter LIKE '%$text%' OR tarif_permtr LIKE '%$text%' OR jumlah_bayar LIKE '%$text%' OR nama_petugas LIKE '%$text%' OR nama_pelanggan LIKE '%$text%' OR status LIKE '%$text%'";
	}
