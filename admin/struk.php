...
<body onload="window.print()"  style="font-family:monospace;" >
	<table style="background: url('../images/logo_pdam7.png') center no-repeat;
			background-size: 50%;">
		<tr>
			<td colspan="6" align="center"><center>STRUK PEMBAYARAN TAGIHAN AIR</center></td>
		</tr>
		<br>
		<tr>
		...
		<tr>
			...
			<td align="left">:</td>
			<td align="left"><?php echo $tarif['beban']; ?></td>
		</tr>
		<tr>
			<td align="left">TAGIHAN PELANGGAN</td>
			<td align="left">:</td>
		...
		<tr>
			...
			<td align="left">:</td>
			<td align="left"><?php echo strtoupper(sha1($pembayaran['id_pembayaran'].$_SESSION['id_petugas'])); ?></td>
		</tr>
		...
		<tr>
			<td colspan="6" align="center"><center>Struk ini menyatakan sebagai bukti pembayaran yang sah</center></td>
		</tr>
		<tr>
			<td colspan="6" align="center">TERIMA KASIH</td>
		</tr>
		<tr>
			<td colspan="6" align="center">BUMDES MBINALUN PAYMENT/<?php echo $_SESSION['nama_petugas']."/".$pembayaran['waktu_bayar']; ?></td>
		</tr>
	</table>
</body>
</html>